...
const routeMeta: Record<string, { title: string; description: string; canonical: string }> = {
  '/': {
    ...
    canonical: 'https://theroyalneststudiohouse.com/'
  },
  '/about': {
    ...
    canonical: 'https://theroyalneststudiohouse.com/about'
  },
  '/rooms': {
    ...
    canonical: 'https://theroyalneststudiohouse.com/rooms'
  },
  '/gallery': {
    ...
    canonical: 'https://theroyalneststudiohouse.com/gallery'
  },
  '/location': {
    ...
    canonical: 'https://theroyalneststudiohouse.com/location'
  },
  '/pricing': {
    ...
    canonical: 'https://theroyalneststudiohouse.com/pricing'
  },
  '/testimonials': {
    ...
    canonical: 'https://theroyalneststudiohouse.com/testimonials'
  },
  '/contact': {
    ...
    canonical: 'https://theroyalneststudiohouse.com/contact'
  },
  '/faq': {
    ...
    canonical: 'https://theroyalneststudiohouse.com/faq'
  },
  '/blog': {
    ...
    canonical: 'https://theroyalneststudiohouse.com/blog'
  },
  '/blog/best-womens-pg-kct-tech-park': {
    ...
    canonical: 'https://theroyalneststudiohouse.com/blog/best-womens-pg-kct-tech-park'
  },
  '/blog/working-womens-hostel-saravanampatti': {
    ...
    canonical: 'https://theroyalneststudiohouse.com/blog/working-womens-hostel-saravanampatti'
  },
  '/blog/ladies-hostel-monthly-rent-coimbatore': {
    ...
    canonical: 'https://theroyalneststudiohouse.com/blog/ladies-hostel-monthly-rent-coimbatore'
  },
  '/blog/safe-womens-accommodation-coimbatore': {
    ...
    canonical: 'https://theroyalneststudiohouse.com/blog/safe-womens-accommodation-coimbatore'
  },
