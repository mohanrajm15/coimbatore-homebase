...
const BestWomensPgKctTechPark = () => {
  useEffect(() => {
    ...
    if (ogDescription) ogDescription.setAttribute("content", "Complete guide to finding the best ladies hostel near KCT Tech Park Saravanampatti. AC rooms, WiFi, security, and affordable monthly rent for working women.");
    const twitterDescription = document.querySelector('meta[name="twitter:description"]');
    if (twitterDescription) twitterDescription.setAttribute("content", "Complete guide to finding the best ladies hostel near KCT Tech Park Saravanampatti. AC rooms, WiFi, security, and affordable monthly rent for working women.");
