      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl animate-fade-in">
          <div className="inline-block bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-semibold mb-4">
            👩 Women's Hostel • Newly Opened Sept 2025
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Women's Hostel in Saravanampatti
            <span className="block text-primary mt-2">Safe PG for Students & Working Women Near Tech Parks</span>
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground mb-8">
            A premium women's hostel in Saravanampatti. Safe, comfortable, and modern long-stay living for students & working professionals. Built over 11,000 sq ft with spacious common areas.
          </p>
